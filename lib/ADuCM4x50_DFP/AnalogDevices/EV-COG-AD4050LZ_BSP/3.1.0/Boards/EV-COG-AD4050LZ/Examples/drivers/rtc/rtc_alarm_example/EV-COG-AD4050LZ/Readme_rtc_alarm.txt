         Analog Devices, Inc. EV-COG-AD4050LZ Application
...
Hardware Setup:
===============
  EV-COG-AD4050LZ configured with default settings.
...
=====================
  Build the project, load the executable to EV-COG-AD4050LZ, open a "Terminal Window" and run it.
...
References:
===========
  EV-COG-AD4050LZ Hardware Reference Manual
