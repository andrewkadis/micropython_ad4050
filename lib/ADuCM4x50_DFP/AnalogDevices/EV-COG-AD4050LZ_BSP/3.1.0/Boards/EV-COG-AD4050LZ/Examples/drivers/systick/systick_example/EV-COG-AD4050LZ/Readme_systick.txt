...
Description:
============
  Use the SysTick timer to wait for a specific number of interrupts.
...
=====================
  Build the project and download to a single ADuCM4x50 target.  View the terminal and run.
