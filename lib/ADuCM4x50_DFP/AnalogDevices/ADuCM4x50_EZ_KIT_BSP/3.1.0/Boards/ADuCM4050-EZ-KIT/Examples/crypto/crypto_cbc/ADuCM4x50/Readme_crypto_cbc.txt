...
Description:  Application example demonstrating the Crypto device driver in various cbc mode.
 

Overview:
=========
    This example demonstrates configuration of the Crypto device driver to perform a cipher 
	encrypt/decrypt operation.  
    
    The application performs the usual declarations and initializations, followed by a cbc crypto 
	data transformation.
    
	For modes, known NIST input data is used for encryption and the encrypted data is 
...
==========================
	CRYPTO_ENABLE_CALLBACK
		This macro is controlled at the top of the crypto_cbc.c source file and controls use of
...
=====================
	The example performs the following operations and reports progress to the Terminal I/O window:
		1. Encode and decode NIST data using CBC cipher mode. Test encrypted data against NIST standard.
