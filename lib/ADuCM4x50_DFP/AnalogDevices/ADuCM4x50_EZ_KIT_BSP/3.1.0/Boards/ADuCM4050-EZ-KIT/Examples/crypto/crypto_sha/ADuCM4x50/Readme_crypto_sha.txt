...
Project Name: crypto_sha

Description:  Application example demonstrating the Crypto device driver in sha various cipher mode.
...
=========
    ...
    The application performs the usual declarations and initializations, followed by a sha crypto 
	data transformation.
    
	For SHA-256, random data is used and decrypted results are verified against origional input data.
...
=====================
	The example performs the following operations and reports progress to the Terminal I/O window:
		1. Compute the SHA-256 hash of two different blocks of random data.
