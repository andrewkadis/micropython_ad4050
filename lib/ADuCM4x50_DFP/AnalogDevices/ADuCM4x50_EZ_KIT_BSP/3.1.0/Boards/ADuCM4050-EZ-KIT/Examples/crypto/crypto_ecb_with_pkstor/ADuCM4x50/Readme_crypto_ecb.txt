...
Project Name: crypto_ecb

Description:  Application example demonstrating the Crypto device driver in ecb cipher mode.
              Duplicate of simple ECB example but adds use of PKSTOR CRYPTO extensions for managing keys.
...
=========
    ...
    The application performs the usual declarations and initializations, followed by a ecb crypto 
	data transformation.
    
	For ECB mode, known NIST input data is used for encryption and the encrypted data is 
